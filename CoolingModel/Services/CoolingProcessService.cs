...
using HSM_CommonCS.Messages.Cooling;
...
public class CoolingProcessService : AppService
{
    ...
    public CoolingProcessService()
    {
        ...
        _dispatcher.Register<OnlineCoolingSetupReq>(OnlineCoolingSetupReq.MessageId, OnOnlineCoolingSetupReq);
    }

    public async Task StartListeningAsync()
    {
        await Bus.StartConsumerAsync("COOLINGMODEL", _dispatcher.Dispatch);
    }

    private Task OnOnlineCoolingSetupReq(OnlineCoolingSetupReq msg)
    {
        Log.Info("Online cooling setup received for piece {PieceNo} ({PieceId})",
            msg.InPieceNo, msg.InPieceId);
